...
export default function Authmodel({}: Props) {
  return (
    <div className='absolute bg-opacity-60 h-full w-full bg-black flex items-centre justify-center z-10'>
      <div className='w-full sm:w-[450x] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex justify-center items-center'>
        <div className='relative w-full h-full mx-auto flex items-center justify-center'>
          <div className='bg-white rounded-full shadow relative w-[40%] bg-blue-600 Uto-slate-900 mx-6'>
